                        ...
                        <Card className="bg-gradient-to-br from-slate-50 to-white border-slate-100 shadow-sm">
                            <CardHeader className="pb-2">
                                ...
                                <CardDescription className="text-xs">
                                    Essential skills that define world-class product leadership.
                                </CardDescription>
                            </CardHeader>
                            <CardContent className="space-y-4">
                                <div className="space-y-2">
                                    <h4 className="text-[11px] font-bold uppercase tracking-wider text-slate-600/70">Key Objectives</h4>
                    ...
                    <div className="space-y-4">
                        <div className="flex items-center justify-between border-b pb-2">
                            <h3 className="text-sm font-bold flex items-center gap-2">
                                ...
                                Podcast Insights & Wisdom
                            </h3>
                            <Badge variant="secondary" className="text-[10px] font-medium">{insights.length} Insights</Badge>
                        </div>
